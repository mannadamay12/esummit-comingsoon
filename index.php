...
if(isset($_POST['submit'])){
	...
	{ 		
			...
			$mail->isHTML(true);
			$mail->Subject = 'EDC ';
			$mail->Body    = '<b>You have been successfully registered.<b>';
            $mail->send();
...
<body>
  ...
  <li><a href="#">- Dropdown Item</a></li>
                            ...
                            <a href="https://www.edctiet.com/" target="_blank" class=" confer-btn mt-3 mt-lg-0 ml-3 ml-lg-5">Know More About Us<i class="zmdi zmdi-long-arrow-right"></i></a>
                        </div>
    ...
    <section class="welcome-area" id="mobile">
        <div class="welcome-slides owl-carousel owl-loaded owl-drag">
            <div class="single-welcome-slide bg-img bg-overlay jarallax" style="background-image: url(img/bg-img/45.jpg);position: relative;">
    ...
    <section id="gallery">
        <div class="container-fluid gallery-container our-speaker-area bg-img bg-gradient-overlay section-padding-100-60" style="background-image: url(img/bg-img/3.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                ...
                <div class="tz-gallery">
                    <div class="row">
                        ...
                        <div class="col-12 text-center mt-50">
                            <div class="hero-btn-group" data-animation="fadeInUp" data-delay="700ms">
                                <a href="gallery.html" class="confer-btn" style="text-decoration: none; font-weight: bold;">View All <i class="zmdi zmdi-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        <div class="single-footer-widget mb-60 wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <div class="footer-contact-info">
                                ...
                                <p><i class="zmdi zmdi-email"></i><a href="mailto:tuedcell@gmail.com" style="color: #9293bc">tuedcell@gmail.com</a></p>
                                <p><i class="zmdi zmdi-globe"></i><a href="https://www.edctiet.com" style="color: #9293bc;">www.edctiet.com/</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-12">
                        <div class="copywrite-text">
                            <p>
                                ...
                                website is made
                                with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://www.edctiet.com/" target="_blank">Technical Team, EDC-TIET</a>
                            </p>
                        </div>
                    </div>
                </div>
